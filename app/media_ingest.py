...
(документ «{ctx}»). Изложи его как фрагмент инструкции для сотрудника:
- какой это экран/система и что на нём ключевое (поля, колонки, кнопки, значения);
- ОСОБО ВАЖНО: рукописные и цветные аннотации — стрелки, рамки, обводки, цифры.
  Для КАЖДОЙ укажи, на какой элемент она указывает, и какой ПОРЯДОК ДЕЙСТВИЙ
  задают аннотации вместе — изложи его нумерованными шагами.
Ничего не выдумывай: описывай только то, что видно. Язык: русский."""
